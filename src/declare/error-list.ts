...
export const ERROR_LIST: Record<ERROR_CODE, string> = {
    ...
    [ERROR_CODE.LIST_FILTER_ARGUMENT_SHOULD_BE_A_FUNCTION]: "List Filter argument should be a function", // 2410
    [ERROR_CODE.LIST_FOR_EACH_ARGUMENT_SHOULD_BE_A_FUNCTION]: "List For Each argument should be a function", // 2411
    [ERROR_CODE.LIST_MAP_ARGUMENT_SHOULD_BE_A_FUNCTION]: "List Map argument should be a function", // 2412
    [ERROR_CODE.LIST_REDUCE_ARGUMENT_SHOULD_BE_A_FUNCTION]: "List Reduce argument should be a function", // 2413
