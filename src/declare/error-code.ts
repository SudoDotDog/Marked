...
export enum ERROR_CODE {
    ...
    LIST_FILTER_ARGUMENT_SHOULD_BE_A_FUNCTION = 2410,
    LIST_FOR_EACH_ARGUMENT_SHOULD_BE_A_FUNCTION = 2411,
    LIST_MAP_ARGUMENT_SHOULD_BE_A_FUNCTION = 2412,
    LIST_REDUCE_ARGUMENT_SHOULD_BE_A_FUNCTION = 2413,
    ...
    CYCLED_IMPORT = 6004,
    UNNECESSARY_ASYNC_EXPRESSION = 6005,
    UNNECESSARY_AWAIT_EXPRESSION = 6006,
